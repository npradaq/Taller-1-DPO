...
public class CalculadoraEstadisticas
{
	...
	public String nombrePaisDeAtleta(String nombreAtleta)
	{
		String nombrePais;

		Atleta atletaConsulta = buscarAtleta(nombreAtleta);
		
		Pais paisDeAtletaConsulta = atletaConsulta.darPais();

		nombrePais = paisDeAtletaConsulta.darNombre();

...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarPaisDelAtletaSeleccionado();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país de un atleta dado");
	...
	/*
	 * Ejecutar la opcion para consultar el pais de un atleta.
	 */
	private void ejecutarPaisDelAtletaSeleccionado()
	{
		System.out.println("\n" + "Pais de un atleta" + "\n");

		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");

		String nombrePais = calculadora.nombrePaisDeAtleta(nombre_atleta);

		System.out.println("El país de el jugador " + nombre_atleta + " es " + nombrePais);
